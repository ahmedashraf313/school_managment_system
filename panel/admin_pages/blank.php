...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="view_sections.php">View Sections</a>
                                </li>
                                <li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="guests_log.php">Guests Log</a>
                                </li>
                                <li>
                                    <a href="users_log.php">Users Log</a>
                                </li>
                                <li>
                                    <a href="comments_log.php">Comments Log </a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="add_answer.php">Add Answer</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="index.php">Blank Page</a>
                                </li>
                                <li>
   ...
   <script type="text/javascript" src="../admin_process.js" ></script>
...
<?php }
    ...
    header("Location:http://localhost/school_managment_system/panel/");
