<?php
require "panel/connection/conn.php";
...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="view_comments.php">comments history</a>
                                </li>
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="http://localhost/INTERA_ZERO/TASKS/final_task/panel/index.php">Login Page</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
    ...
    <script src="panel/admin_process.js"></script>
